...
**API + contract context for Stitch / design agents** (OpenAPI, brief, examples, Postman) lives in **[`../stitch-context/README.md`](../stitch-context/README.md)** — use that folder when feeding backend context. **Stitch 6-file upload limit:** flattened bundle in [`../stitch-google-6files/`](../stitch-google-6files/). This folder (`stitch/`) is for **visual** exports from Stitch.
