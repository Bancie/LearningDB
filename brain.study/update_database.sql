...
ALTER TABLE PRIOR_ACT DROP FOREIGN KEY PRIOR_ACT_ibfk_1;

ALTER TABLE POSTERIOR_ACT DROP FOREIGN KEY POSTERIOR_ACT_ibfk_1;

DROP TABLE IF EXISTS PRIOR_ACT;

DROP TABLE IF EXISTS POSTERIOR_ACT;

ALTER TABLE TARGET_TIME DROP FOREIGN KEY TARGET_TIME_ibfk_1;
ALTER TABLE TARGET_TIME DROP FOREIGN KEY TARGET_TIME_ibfk_2;

DROP TABLE IF EXISTS TARGET_TIME;